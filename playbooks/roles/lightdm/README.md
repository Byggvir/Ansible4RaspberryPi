...
Die Rolle lightdm führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle lightdm nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle lightdm nutzt folgende Variablen in vars:
...
Die Rolle lightdm nutzt folgende Templates in *templates*:
...
Die Rolle lightdm nutzt folgende Dateien in *files*:
...
Die Rolle lightdm nutzt folgende Meta-Daten:
