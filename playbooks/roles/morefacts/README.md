...
Die Rolle morefacts führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle morefacts nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle morefacts nutzt folgende Variablen in vars:
...
Die Rolle morefacts nutzt folgende Templates in *templates*:
...
Die Rolle morefacts nutzt folgende Dateien in *files*:
...
Die Rolle morefacts nutzt folgende Meta-Daten:
