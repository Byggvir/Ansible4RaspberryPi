...
Die Rolle timezone führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle timezone nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle timezone nutzt folgende Variablen in vars:
...
Die Rolle timezone nutzt folgende Templates in *templates*:
...
Die Rolle timezone nutzt folgende Dateien in *files*:
...
Die Rolle timezone nutzt folgende Meta-Daten:
