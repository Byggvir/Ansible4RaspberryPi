...
Die Rolle jitsi führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle jitsi nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle jitsi nutzt folgende Variablen in vars:
...
Die Rolle jitsi nutzt folgende Templates in *templates*:
...
Die Rolle jitsi nutzt folgende Dateien in *files*:
...
Die Rolle jitsi nutzt folgende Meta-Daten:
