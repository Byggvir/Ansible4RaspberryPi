...
Die Rolle reboot führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle reboot nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle reboot nutzt folgende Variablen in vars:
...
Die Rolle reboot nutzt folgende Templates in *templates*:
...
Die Rolle reboot nutzt folgende Dateien in *files*:
...
Die Rolle reboot nutzt folgende Meta-Daten:
