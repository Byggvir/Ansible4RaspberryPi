...
Die Rolle ip-forward führt Tasks aus, die wie folgt gruppiert sind:
...
Die Rolle ip-forward nutzt folgende Variablen in *defaults* und / oder *vars*:

Die Rolle ip-forward nutzt folgende Variablen in vars:
...
Die Rolle ip-forward nutzt folgende Templates in *templates*:
...
Die Rolle ip-forward nutzt folgende Dateien in *files*:
...
Die Rolle ip-forward nutzt folgende Meta-Daten:
